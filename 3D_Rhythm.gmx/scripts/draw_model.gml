...
shader_set_uniform_vec3(shd_simple, "_direction", _fx, _fy, _fz);
shader_set_uniform_vec3(shd_simple, "_side", _rx, _ry, _rz);
shader_set_uniform_vec3(shd_simple, "_up", _ux, _uy, _uz);
shader_set_uniform_float(shd_simple, "_size", _size);
shader_set_uniform_vec4(shd_simple, "_colour", colour_get_red(_colour) / 255, colour_get_green(_colour) / 255, colour_get_blue(_colour) / 255, _alpha);
